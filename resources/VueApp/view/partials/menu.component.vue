    ...
    <div class="container">
        <div class="classy-nav-container breakpoint-off">
            <nav class="classy-navbar justify-content-between" id="horizontalNav">
                ...
                <!-- Logo -->
                <a href="index.html" class="nav-brand"><img src="img/core-img/small-logo.png" alt="Mobile Logo"></a>
                        ...
                        <ul>
                            ...
                            <!-- <li class="megamenu-item"><a href="#"><i class="fa fa-laptop"></i> UI Elements</a>
                                <div class="megamenu">
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Advanced Elements</li>
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Icons</li>
                                        <li><a href="elegant-icon.html">- Elegant Icons</a></li>
                                        <li><a href="et-line-icon.html">- Et-line Icon</a></li>
                                        <li><a href="font-awsome.html">- Font-Awsome Icon</a></li>
                                        <li><a href="matarial-icon.html">- Materialize Icon</a></li>
                                        <li><a href="pe-7-strok.html">- Pe-7 Stroke Icon</a></li>
                            ...
                            <!-- <li class="megamenu-item"><a href="#"><i class="fa fa-dashcube"></i> Data</a>
                                <div class="megamenu">
                                    ...
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Hot Page</li>
                                        <li><a href="inbox.html">- E-mail Inbox</a></li>
